...
<head>
    ...
    <title>My Account - Hogwarts University Library</title>
...
<body>
    <div>
        ...
        <div id="MainContent" class="centreText">
            ...
            <div id="Filter" class="">
                ...
                <div id="FilterContents">
                                ...
                                <div class="ResultBox  col-7">
                                    <div class="AllInfo">
                                        ...
                                        <div class="ReturnBook">
                                            <a href="">
                                                <img style="vertical-align:middle; display:inline" src="images/AccountPage/Return Book.png">
                                                <h3>Return</h3>
                                            </a>
                                        </div>
                    ...
                    <div id="showMoreResultsDiv">
                        <div class="ShowMoreResults " onclick="ShowMoreResults()">
            ...
            <div id="FavGenre">
                <div class="FavouriteGenre  col-7">
            ...
            <div id="Account" class="centreText">
                <div class="centreText AccountSettings  col-7">
